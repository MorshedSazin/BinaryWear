...
<body class="bg-gray-900 text-gray-100 flex flex-col min-h-screen">
    ...
    <main class="container mx-auto px-6 py-16 flex-grow">
        ...
        <div class="max-w-full mx-auto bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            <div class="md:flex">
                <!-- Left Sidebar -->
                <div class="md:w-1/3 bg-gray-800 p-16 flex flex-col items-center">
                    <img src="https://via.placeholder.com/150" alt="Profile Picture" class="rounded-full border-4 border-green-400 w-48 h-48">
                    <h2 class="text-4xl font-bold mt-4"><?php echo htmlspecialchars($user_data['NAME']); ?></h2>
                    <p class="text-base text-gray-400">ID: <?php echo htmlspecialchars($user_data['SL']); ?></p>
                    
                </div>

                <!-- Right Content -->
                <div class="md:w-2/3 p-16">
                    <!-- Contact Information -->
                    <div>
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-3xl font-bold text-green-400">Contact Information</h3>
                            <button id="edit-button" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded text-base transition-colors duration-300">
                                <i class="fas fa-pencil-alt mr-2"></i>Edit
                            </button>
                            <button id="save-button" type="submit" form="profile-form" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded text-base transition-colors duration-300 hidden">
                                <i class="fas fa-save mr-2"></i>Save
                            </button>
                            <button id="cancel-button" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded text-base transition-colors duration-300 hidden ml-2">
                                <i class="fas fa-times mr-2"></i>Cancel
                            </button>
                        </div>
                        <form id="profile-form" action="update_profile.php" method="POST">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10 text-base">
                            <div>
                                ...
                                <div id="address-edit" class="hidden">
                                    ...
                                    <input type="text" id="edit-address" name="PRESENT_ADDRESS" value="<?php echo htmlspecialchars($user_data['PRESENT_ADDRESS']); ?>" class="w-full bg-gray-700 text-white rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500">
                                </div>
                            </div>
                            <div>
                                ...
                                <div id="linux-distro-edit" class="hidden">
                                    ...
                                    <input type="text" id="edit-linux-distro" name="FAVORITE_LINUX_DISTRO" value="<?php echo htmlspecialchars($user_data['FAVORITE_LINUX_DISTRO']); ?>" class="w-full bg-gray-700 text-white rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500">
                                </div>
                            </div>
                            <div>
                                ...
                                <div id="email-edit" class="hidden">
                                    ...
                                    <input type="email" id="edit-email" name="EMAIL" value="<?php echo htmlspecialchars($user_data['EMAIL']); ?>" class="w-full bg-gray-700 text-white rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500">
                                </div>
                            </div>
                            <div>
                                ...
                                <div id="phone-edit" class="hidden">
                                    ...
                                    <input type="tel" id="edit-phone" name="PHONE" value="<?php echo htmlspecialchars($user_data['PHONE']); ?>" class="w-full bg-gray-700 text-white rounded-md px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500">
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <!-- Order History -->
                    <div class="mt-10">
                        <h3 class="text-3xl font-bold text-green-400 mb-4">Order History</h3>
                        <div class="space-y-4">
                            <!-- Order Item -->
